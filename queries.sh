...
echo "$($PSQL "SELECT DISTINCT(name) FROM teams INNER JOIN games ON winner_id = teams.team_id OR opponent_id = teams.team_id WHERE round = 'Eighth-Final' AND year = 2014 ORDER BY name")"
